...
variable "host_project_ids" {
  ...
  description = "Map of $${subunit}/$${environment}/$${zone} or common/$${environment}/$${zone} to Shared VPC host project id."
  type        = map(string)
  # nullable    = false
}
...
variable "vpc_self_links" {
  # tfdoc:variable:source 2-networking
  description = "Map of $${subunit}/$${environment}/$${zone} or common/$${environment}/$${zone} to Shared VPC self_link."
  type        = map(string)
  nullable    = false
}
